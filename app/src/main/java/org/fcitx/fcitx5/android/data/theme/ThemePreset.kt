...
object ThemePreset {
    ...
    val InkBlack = Theme.Builtin(
        name = "InkBlack",
        isDark = false,
        backgroundColor = 0xffd9d9d9,
        barColor = 0xffffffff,
        keyboardColor = 0xffffffff,
        keyBackgroundColor = 0xffffffff,
        keyTextColor = 0xff000000,
        candidateTextColor = 0xff000000,
        candidateLabelColor = 0xff000000,
        candidateCommentColor = 0xff9b9b9b,
        altKeyBackgroundColor = 0xffffffff,
        altKeyTextColor = 0xff000000,
        accentKeyBackgroundColor = 0xff000000,
        accentKeyTextColor = 0xffffffff,
        keyPressHighlightColor = 0x1f000000,
        keyShadowColor = 0xffcfcfcf,
        popupBackgroundColor = 0xffffffff,
        popupTextColor = 0xff000000,
        spaceBarColor = 0xff000000,
        dividerColor = 0x1f000000,
        clipboardEntryColor = 0xffffffff,
        genericActiveBackgroundColor = 0xff000000,
        genericActiveForegroundColor = 0xffffffff
    )

    val InkPink = Theme.Builtin(
        name = "InkPink",
        isDark = false,
        backgroundColor = 0xffd9d9d9,
        barColor = 0xffffffff,
        ...
        altKeyBackgroundColor = 0xffffffff,
        altKeyTextColor = 0xff000000,
        accentKeyBackgroundColor = 0xffff8f9f,
        accentKeyTextColor = 0xffffffff,
        keyPressHighlightColor = 0x1f000000,
        keyShadowColor = 0xffcfcfcf,
        popupBackgroundColor = 0xffffffff,
        ...
        dividerColor = 0x1f000000,
        clipboardEntryColor = 0xffffffff,
        genericActiveBackgroundColor = 0xffff8f9f,
        genericActiveForegroundColor = 0xffffffff
    )

    val InkBlackDark = Theme.Builtin(
        name = "InkBlackDark",
        isDark = true,
        backgroundColor = 0xff1b1b1b,
        barColor = 0xff000000,
        keyboardColor = 0xff000000,
        keyBackgroundColor = 0xff000000,
        keyTextColor = 0xffffffff,
        candidateTextColor = 0xffffffff,
        candidateLabelColor = 0xffffffff,
        candidateCommentColor = 0xff8f8f8f,
        altKeyBackgroundColor = 0xff000000,
        altKeyTextColor = 0xffffffff,
        accentKeyBackgroundColor = 0xffffffff,
        accentKeyTextColor = 0xff000000,
        keyPressHighlightColor = 0x33ffffff,
        keyShadowColor = 0xff2a2a2a,
        popupBackgroundColor = 0xff000000,
        popupTextColor = 0xffffffff,
        spaceBarColor = 0xffffffff,
        dividerColor = 0x1fffffff,
        clipboardEntryColor = 0xff000000,
        genericActiveBackgroundColor = 0xffffffff,
        genericActiveForegroundColor = 0xff000000
    )

    val InkPinkDark = Theme.Builtin(
        name = "InkPinkDark",
        isDark = true,
        backgroundColor = 0xff1b1b1b,
        barColor = 0xff000000,
